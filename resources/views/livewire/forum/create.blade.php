<div>
    <div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <span class="hidden sm:inline-block sm:align-middle sm:h-screeindex.bn"></span>​
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="">
                            ...
                            <input type="hidden" wire:model="id">
                                <label for="formnama" class="block text-gray-700 text-sm font-bold mb-2">Nama Tema:</label>
                            ...
                            <div class="mb-4">
                                <input type="hidden" wire:model="id">
                                    <label for="formpenyelenggara" class="block text-gray-700 text-sm font-bold mb-2">Nama Penyelenggara:</label>
                                    <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formpenyelenggara" wire:model="penyelenggara">
