                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control" wire:model="peringkat" id="forPeringkat" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            ...
                            @error('peringkat') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="formpenyelenggara_prestasi" class="block text-gray-700 text-sm font-bold mb-2">Penyelenggara Prestasi:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formpenyelenggara_prestasi" wire:model="penyelenggara_prestasi">
