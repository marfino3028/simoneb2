        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('laporanBeasiswa') }}" :active="request()->routeIs('laporanBeasiswa')">
                        {{ __('Laporan Perkembangan PM Beasiswa') }}
                    </x-jet-nav-link> 
					<x-jet-dropdown>
						<x-slot name="trigger">                            
                ...
                <x-jet-dropdown class="mt-8 h-4" align="right">
                    <x-slot name="trigger">                            
                            <button class="flex items-center text-md font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                <div>{{ __('9 Portofolio')}}</div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" src="public{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" />
                </div>
